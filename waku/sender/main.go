...
func main() {
	if len(os.Args) != 2 {
		fmt.Println("Not correctly called. Usage: sender <message>")
		return
	}
	msg := os.Args[1]
	...
	nickFlag := flag.String("nick", "Initiator", "nickname to use in chat. will be generated if empty")
